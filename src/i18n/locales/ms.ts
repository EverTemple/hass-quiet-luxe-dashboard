...
export const ms: TranslationTable = {
  ...
  'control.more': 'Kawalan lain',
  'control.hvac_mode': 'Mod HVAC',
  'control.temperature_range': 'Julat suhu',
  'control.heat_to': 'Panaskan ke',
  'control.cool_to': 'Sejukkan ke',
  'control.fan': 'Kipas',
  'control.swing': 'Ayunan',
  'control.swing_vertical': 'Menegak',
  'control.swing_horizontal': 'Mendatar',
  'control.humidity_mode': 'Mod kelembapan',
  'climate.now': 'Kini',
  'climate.set_to': 'Ditetapkan ke',
  'climate.heating': 'Memanaskan',
  'climate.cooling': 'Menyejukkan',
  'air.good': 'Baik',
  'air.fair': 'Sederhana',
  'air.poor': 'Buruk',
  'air.very_poor': 'Sangat buruk',
  'fan.sweep_aim': 'Arah ayunan',
  'fan.aim_hint': 'Seret bentuk kipas untuk menala arah',
  'fan.span_held': 'sudut dikekalkan pada',
  'fan.min_span': 'Sudut minimum',
  'fan.release_to_set': 'lepaskan untuk tetapkan',
};
